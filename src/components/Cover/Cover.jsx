...
function Cover(){
  ...
  return (
    <div className="_cover_wrapper">
      ...
      <div className="_cover_hero_info">
        <div className="_header_logo_container">
          <img className="_ia_header_logo" src="https://www.intract.io/assets/academy-animated-logo-57b2ae61.gif" alt="intract-academy-logo"/>
        </div>
        <div className="_cover_hero_text">
